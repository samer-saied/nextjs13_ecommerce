    ...
    return (
        <>
            {cart.products.map((product) => (
                <div className="flex flex-row" key={product.productId}>
                    <p>{product.productId}</p>
                    <p>X</p>
                    <p>{product.quantity}</p>
                </div>
            ))}
            {/* <div key={product.id} className=" relative h-auto px-5  bg-white m-2 p-2 border border-x-gray-100 rounded-md hover:-translate-y-3 hover:shadow-lg duration-100 ease-in">
